...
#cnpm install --save sass-loader node-sass mobx-react mobx babel-preset-stage-0 babel-plugin-transform-decorators-legacy babel-polyfill babel-preset-es2015 axios